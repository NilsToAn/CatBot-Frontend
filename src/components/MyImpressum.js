...
export default function MyImpressum() {
    return (
        <>
        <Figure>
            <Figure.Image        
...
<span className="textHeader">Impressum</span>
<p>
{`
Angaben gemäß § 5 TMG
...
<span className='textHeader'>Kontakt</span>
<p>{`
Telefon: 0176 92681656
E-Mail: travel-catbot@web.de
`}
</p>
<span className='textHeader'>Verbraucherstreitbeilegung/Universalschlichtungsstelle</span>
<p>
{`
Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen. 
`}
</p>
<span className='textHeader'>Haftung für Inhalte</span>
<p>
{`
...
<span className='textHeader'>Haftung für Links</span>
<p>
{`
...
Rechtswidrige Inhaltewaren zum Zeitpunkt der Verlinkung nicht erkennbar.
Eine permanente inhaltliche Kontrolle der verlinkten Seiten ist jedoch ohne konkrete Anhaltspunkte einer Rechtsverletzung nicht zumutbar. 
Bei Bekanntwerden von Rechtsverletzungen werden wir derartige Links umgehend entfernen.
`}
</p>
<span className='textHeader'>Urheberrecht</span>
<p>
{`
